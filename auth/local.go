...
func NewLocalAuth(cfg cfg.BackendConfig, appCfg cfg.AppConfig) *LocalAuth {
...
func (l LocalUser) PolicySet() cfg.IdentityPolicySet {
	return cfg.DefaultIdentityPolicySet()
}
